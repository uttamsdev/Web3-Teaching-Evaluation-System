...
const StudentTopBar = ({ showNav, setShowNav }) => {
    ...
    return (
        <div className={`bg-white fixed w-full h-16 flex justify-between items-center transition-all duration-[400ms] ${showNav ? "pl-56" : ""}`}>
                ...
                <Menu as="div" className="relative inline-block text-left">
                    <div>
                        <Menu.Button className='inline-flex w-full justify-center items-center'>
                            ...
                            <span className='hidden md:block font-medium text-gray-700'>Student</span>
