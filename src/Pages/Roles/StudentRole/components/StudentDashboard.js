...
const StudentDashboard = () => {
    return (
        ...
        <p className='text-center text-[#16728e]  text-xl md:text-xl py-3 border-l-8 border-[#5bc0de]  mb-8 bg-[#4bc3e41d] rounded-md w-9/12 md:w-6/12 mx-auto'>Hey Dear Student, You are welcome to your dashboard.</p>
