...
const StudentCourses = () => {
  ...
  return (
    ...
    <p className='text-white text-2xl mb-10 font-bold bg-[#039BE5] h-24 flex items-center rounded-t-xl'><MdOutlineLibraryBooks className='ml-5 mr-3 w-6 h-6'/>My Courses</p>
    <div>
