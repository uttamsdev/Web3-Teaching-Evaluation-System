    ...
    return (
        <div className='bg-[#F5F5F5] calc-height rounded-b-3xl'>
            ...
            <div className='w-[325px] md:w-[600px] mx-auto'>
                <p className='text-center text-[#b56a00] text-xl md:text-xl py-3 border-l-8 border-[#F0AD4E]  mb-8 bg-[#F4EEE4] rounded-md'>Please fill up the form to add new courses.</p>
